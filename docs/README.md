...
4. [`decision-fidelity-pusht-company-runbook.md`](decision-fidelity-pusht-company-runbook.md)
   freezes the first two Push-T gates, two-node company allocation, environment
   setup, pairing checks, and result-recording contract.
5. [`unordered-generative-fidelity.md`](unordered-generative-fidelity.md) records the
   completed Push-T decision-level discovery and held-out conclusion.
6. [`literature-review.md`](literature-review.md) separates established top-venue
   results from current preprints and locks the novelty boundary.
7. [`research-protocol.md`](research-protocol.md) preserves the earlier
   DriftFlowWorld comparison and its historical gates.
8. [`advantage-aligned-transport-hypotheses.md`](advantage-aligned-transport-hypotheses.md)
   preserves the post-PoC mechanism hypotheses and diagnostic gates.
9. [`experiments.md`](experiments.md) records hypotheses, jobs, metrics, and decisions.
10. [`results/`](results/) contains dated, immutable experiment snapshots and analysis.
11. [`weekend-research-plan.md`](weekend-research-plan.md) defines the earlier
   four-node aggressive follow-up.
12. [`research-idea.md`](research-idea.md) preserves the original broader proposal.
